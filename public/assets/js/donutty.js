...
(function( doc, win ) {
    ...
    donutty = win.Donutty = function( el, options ) {
        ...
        this.options.transition =  this.options.transition || "all 0s cubic-bezier(0.57, 0.13, 0.18, 0.98)";
    ...
    donutty.prototype.createText = function() {
        ...
        this.$text.innerHTML = this.options.value + "%";
        this.$text.setAttribute( "style", "color: " + this.options.color + "; position: absolute; top: 0px; left: 50%; margin-left: -45px; line-height: 90px; width: 90px; text-align: center;" );
    ...
    donutty.prototype.createSvg = function() {
        ...
        this.$svg.setAttribute( "width", "90px" );
